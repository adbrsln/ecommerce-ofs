...
include 'include/db.php';
    ...
    if(isset($_SESSION['cart']) && isset($_SESSION['cnum'])){ 
        ...
        while($row=mysqli_fetch_array($query)){ 
           ...
           $query2 = "INSERT INTO corder (transactionid,item_id,user_id,qty,total,ftotal,discount,pos,tdisc,status) VALUES ('$transid','$itemid','$uid','$qty','$total','$ftotal','$discount','$pos','$totaldiscount','Waiting Confirmation')";
