...
if(!isset($_SESSION['cart'])){ 
 echo '<script>alert("Your Cart is empty. Please add some products. you will be redirected to Shopping page!"); window.location = "./index.php";</script><p></p>'; 
}
?>
...
<form method = "POST"  onsubmit= "return confirmation()" action = "p_proses.php">
    ...
    <tr>
       ...
       <input type = "hidden" name = "uid" value = "<?= $uid?>">
        <input type ="submit" name="submit" class ="btn btn-primary"  value = "Place Order Now"> &nbsp; <a class = "btn btn-warning" onclick = "return del();"  href="logout.php" >Clear Shopping Cart</a>
        </div>
